import { Box, Button, Link, useColorMode, Grid, GridItem } from "@chakra-ui/react";
...
const Header = () => {
  ...
  return (
    <Grid templateColumns='repeat(12, 1fr)' gap={4} width="100vw" padding="16px 0" borderBottomWidth="1px" >
      <GridItem colSpan={1}/>
        <GridItem colSpan={2}>
          <Box width="150px">
